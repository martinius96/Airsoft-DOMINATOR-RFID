...
* **In Xloader you need to set route to firmware and set COM port with correct baudrate**
...
* DOMINATION Timer will automatically run on your Arduino board (maybe first restart will be required via RST button after uploading)
